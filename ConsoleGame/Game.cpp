...
void Game::menuClear()
{
	util.printGraphic("───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────", 0, 24);
	cout << "                                                                                          \n";
	cout << "                                                                                          \n";
	cout << "                                                                                          \n";
	cout << "                                                                                          \n";
	cout << "                                                                                          ";
	util.printGraphic("메세지", 3, 27);
	util.printGraphic("│", 12, 25);
	util.printGraphic("│", 12, 26);
	util.printGraphic("│", 12, 27);
	util.printGraphic("│", 12, 28);
	util.printGraphic("│", 12, 29);
	util.printGraphic("│", 90, 25);
	util.printGraphic("│", 90, 26);
	util.printGraphic("│", 90, 27);
	util.printGraphic("│", 90, 28);
	util.printGraphic("│", 90, 29);
}
...
{
	util.printMessage(2000,"돈을 잃으셨습니다");
}
void Game::playerDraw()
{
	util.printMessage(2000, "무승부 하셨습니다");
